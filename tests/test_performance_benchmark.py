...
from mesa_llm.parallel_stepping import enable_automatic_parallel_stepping, step_agents_parallel
...
def main():
    ...
    results = benchmark.run_benchmark(agent_counts=agent_counts, test_model_class=PerformanceTestModel)
