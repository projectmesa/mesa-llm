    ...
    if original_step is not None:
        ...
        def step_wrapper(self: "Model", *args, **kwargs):  # type: ignore[override]
            ...
            if hasattr(self, "recorder"):
                self.recorder.record_model_event("step_start", {"step": self._time})  # type: ignore[attr-defined]
            ...
            if hasattr(self, "recorder"):
                ...
                self.recorder.record_model_event("step_end", {"step": self._time})  # type: ignore[attr-defined]
