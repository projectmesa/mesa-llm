    ...
    if original_step is not None:
        ...
        def step_wrapper(self: "Model", *args, **kwargs):  # type: ignore[override]
            ...
            if hasattr(self, "recorder"):
                self.recorder.record_model_event("step_start", {"step": get_model_step(self)})  # type: ignore[attr-defined]
            ...
            if hasattr(self, "recorder"):
                ...
                self.recorder.record_model_event("step_end", {"step": get_model_step(self)})  # type: ignore[attr-defined]
