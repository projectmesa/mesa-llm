...
class ModuleLLM:
    ...
    def __init__(
        ...
        """
        Initialize the LLM module with optional performance optimizations
    ...
    def _build_rate_limit_error(self, error: RateLimitError) -> RateLimitError:
        ...
        # Compact JSON-style spacing so "key": value → "key":value
        # This normalises output from different providers (e.g. Gemini sends {"code": 429})
    ...
    def generate(
        ...
        """
        Generate a response from LLM using litellm based on the prompt
        ...
        try:
            ...
            try:
                ...
                raise self._build_rate_limit_error(exc) from exc
